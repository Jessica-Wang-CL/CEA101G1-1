	...
	<div class="offcanvas-menu-wrapper">
		...
		<nav class="mainmenu mobile-menu">
			<ul>
				...
				<li><a class="nav-event" href="./rooms.html">度假空間</a>
					<ul class="dropdown">
					...
					<div class="nav-menu">
						<nav class="mainmenu">
							<ul class="mainmenu-left row">
								<li class="col-4"><a href="./pages.html" class="nav-event">會員中心</a>
									<ul class="dropdown">
										<li><a href="./room-details.html">個人檔案</a></li>
										<li><a href="./blog-details.html">我的假期</a></li>
										<li><a href="#">我的足跡</a></li>
									</ul></li>
								<li class="col-4"><a class="nav-event">住客專區</a>
									<ul class="dropdown">
										<li><a href="./activity.html">活動報名</a></li>
										<li><a href="">預約服務</a></li>
										<li><a href="">訂購餐點</a></li>
									</ul></li>
								<li class="col-4"><a href="shop.html" class="nav-evnet">戴蒙商城</a>
								</li>
							</ul>
						</nav>
					</div>
					...
					<div class="nav-menu">
						<nav class="mainmenu">
							<ul class="mainmenu-right row">
								...
								<li class="log-in col-4"><a class="nav-event"><i
										class="fas fa-user-circle log-in"></i></a></li>
							</ul>
						</nav>
					</div>
				</div>
