...
for (int i = 0; i < cookieList.length; i++){
	...
	if (theCookie.getName().equals("dmUser")) {
		mb_acc = theCookie.getValue();
	}
}
if (sessionID != null && mb_acc != null) {
	MembersService memberSvc = new MembersService();
	member = memberSvc.getOneByMbAcc(mb_acc);
	session.setAttribute("member", member);
} else if (sessionID == null && mb_acc != null){
	...
	pageContext.setAttribute("mb_acc", mb_acc);
} 
...
<html lang="en">
    ...
    <body>
        ...
        <div class="login-window hide-login-window">
                ...
                <div class="cont">
                 <form id="login-form" method="POST" action="<%request.getContextPath()%>/MembersServlet">
                    <div class="login-form sign-in">
                        ...
                        <p class="forgot-pass"><a href="">忘記密碼?</a></p>
                    ...
                    <div class="sub-cont">
                        <div class="img">
                            ...
                            <div class="img__btn">
                                <span class="m--up">註冊會員</span>
                                <span class="m--in">會員登入</span>
                            </div>
                        </div>
                         <form id="registration-form" action="${pageContext.request.contextPath}/frontend/members/registration.jsp" method="POST">
                        <div class="form sign-up">
                            <h2>期待您的加入</h2>
                            <label>
                                <span>姓(Last Name)</span>
                                <input type="text" name="temp-lname" autocomplete="false" maxlength="20" required/>
                            </label>
                            <label>
                                <span>名(First Name)</span>
                                <input type="text" name="temp-fname" autocomplete="false" maxlength="20" required/>
                            </label>
                            <label>
                                <span>EMAIL</span>
                                <input type="email" id="temp-email" name="temp-email" pattern="^.+[\x40]{1}.+[.]{1}.*$" autocomplete="false" required/>
                            </label>
                            <label>
                                <span>密碼</span>
                            ...
                            <label>
                                <span>確認密碼</span>
                                <input type="password" id="temp-confirm-password" name="temp-confirm-password" required/>
                            </label>
        ...
        <div class="offcanvas-menu-wrapper">
            ...
            <div class="header-configure-area">
                <img src="${pageContext.request.contextPath}/img/flag.jpeg" alt="" />
            ...
            <nav class="mainmenu mobile-menu">
                <ul>
                    ...
                    <li>
                        <a class="nav-event" href="./rooms.html">客房介紹</a>
                    </li>
                    <li>
        ...
        <div class="homepage-video">
            <video width="condition" type="video/mp4" autoplay="autoplay" loop="loop" muted="muted">
                <source src="${pageContext.request.contextPath}/video/homepage.mp4" type="video/mp4" />
            </video>
        </div>
        <!-- Hero Section End -->
        <div class="booking">
            <form action="index.html" method="get">
                <div class="booking-form">
                    <div class="box">
                        <div class="check-date">
                            <input
                                ...
                                placeholder="入住日期"
                            />
                            <label for="date-in"><i class="icon_calendar"></i></label>
                        </div>
                    </div>
                    <div class="box">
                        <div class="check-date">
                            <input
                                ...
                                placeholder="退房日期"
                            />
                            <label for="date-out"><i class="icon_calendar"></i></label>
                        </div>
                    </div>
                    <div class="box">
                    ...
                    <div class="check-vacant-button">
                        <button type="" id="check-room" class="vacant-check">空房查詢</button>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="about-text">
                            ...
                            <p class="f-para">
                                戴蒙頂級奢華度假村 - 全年都是完美之選。
                                不單從度假村的全包式假期到探索在地特色景點，都給您前所未有的新發現。
                            </p>
                            <p class="s-para">
                                從交通接送、舒適住房、三餐精緻饗宴、全日無限吧台享用飲品與輕食、豐富水陸活動與指導，還有晚間娛樂活動與表演…
                                戴蒙度假村
                            ...
                            <div class="testimonial-slider">
                                <div class="ts-item">
                                    <p>
                                        ...
                                        早餐時我共點了3次熱拿鐵，送來的每一杯的溫度都差很多，（溫涼的，熱的，超熱的），可能要再加強。我愛他們check
                                        out time 12:00,所以可以睡晚一點，吃完早餐再去游泳洗澡後再從容離開飯店。
                                    </p>
                                    <div class="ti-author">
                                        <div class="rating">
                                            <i class="icon_star"></i>
                                    ...
                                    <img src="${pageContext.request.contextPath}/img/testimonial-logo.png" alt="" />
                                </div>
                                <div class="ts-item">
                                    <p>
                                        首先我非常感謝迎賓櫃檯經理
                ...
                <div class="hp-room-items">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/img/resort/room/standard-room.jpg">
                                <div class="hr-text">
                                    <h3>經典海景房</h3>
                                    <h2>20000$<span>/每晚</span></h2>
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="r-o">空間:</td>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/img/resort/room/luxury-room.jpg">
                                <div class="hr-text">
                                    <h3>豪華蜜月房</h3>
                                    <h2>30000$<span>/每晚</span></h2>
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="r-o">空間:</td>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/img/resort/room/deluxe-room.jpeg">
                                <div class="hr-text">
                                    <h3>奢華海景房</h3>
                                    <h2>50000$<span>/每晚</span></h2>
                                    <table>
                                        <tbody>
                                            <tr>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/img/resort/room/Poseidon_Index.jpg">
                                <div class="hr-text">
                                    <h3>波賽頓套房</h3>
                                    <h2>100000$<span>/每晚</span></h2>
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="r-o">空間大小：</td>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="service-item">
                            ...
                            <h4>空中接送</h4>
                            <p>
                                戴蒙度假村有專屬直升機與特殊海關通行許可，讓您無需等待冗長的過關服務，直接由機場出發到您預定的房間。
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
