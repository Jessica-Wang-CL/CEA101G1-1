...
public class RoomTypeService {
	...
	public RoomTypeVO addRoomType(String rm_type, String type_name, Integer rm_price, Integer rm_capacity,
			String rm_info) {
	...
	public RoomTypeVO updateRoomType(String rm_type, String type_name, Integer rm_price, Integer rm_capacity,
			String rm_info) {
